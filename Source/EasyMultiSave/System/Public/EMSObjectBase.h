...
protected:
	...
	virtual FName GetLevelName() const { return NAME_None; };
...
protected:
	...
	bool LoadBinaryData(const FString& FullSavePath, TArray<uint8>& OutData) const;
...
public:
	...
	void ApplyLastFileVersion(FMemoryReader& MemoryReader) const;
...
public:
	...
	bool SaveObjectCollection(const TArray<FRawObjectSaveData>& Objects, const bool bUseSlot) const;
...
private:
	...
	bool ProcessObjectCollection(FMemoryReader& FromBinary, const FSaveObjects& Objects) const;
